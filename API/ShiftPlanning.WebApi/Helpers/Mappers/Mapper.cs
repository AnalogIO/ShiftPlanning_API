    ...
    public static class Mapper
    {
        ...
        public static EmployeeDTO Map(Employee employee)
        {
            ...
            return new EmployeeDTO
            {
                ...
                Roles = employee.Role_.Select(r => r.Name).ToArray(), // new string[0],
        ...
        {
            return new ShiftDTO { Id = shift.Id, Start = shift.Start, End = shift.End, CheckIns = Map(shift.CheckIns), Employees = Map(shift.Employee_), ScheduleId = shift.Schedule?.Id };
        }
